<div class="ninja-deactivation-feedback _modal no-confirmation-message">
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        jQuery('tr[data-slug=""]').on('click', '.deactivate a', function (e) {
            e.preventDefault();
            $('._modal').addClass('active');
            $('._modal a.ninja_action_deactivate').attr('href', $(this).attr('href'));
        });
        ...
        $('._modal input[name="selected-reason"').on('change', function (e) {
           e.preventDefault();
        ...
        $('._modal .ninja-modal-footer').on('click', 'a.ninja_action_deactivate.has_feedback', function (e) {
            e.preventDefault();
...
</script><style type="text/css">.ninja-deactivation-feedback {
        position: fixed;
        overflow: auto;
        height: 100%;
        width: 100%;
